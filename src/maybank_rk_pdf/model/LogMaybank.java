...
public class LogMaybank {
    ...
    public void createLogAllMaybank(String path, String kategori, Statement stmt){
        try {
            ...
            hasilQuery = stmt.executeQuery("SELECT s1 AS kanwil, name2 AS kd_cabang, id_customer, barcode, name3 AS cif, name1, address1, address2, address3, address4, address5, courier_name, ss1 FROM t_log");
